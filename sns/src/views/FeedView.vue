    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        <img src="https://i.pravatar.cc/300?img=15" class="w-[40px] rounded-full">
                        
                        <p><strong>Alyssa Blair</strong></p>
                    </div>

                    <p class="text-gray-600">2 minutes ago</p>
                </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        <img src="https://i.pravatar.cc/300?img=20" class="w-[40px] rounded-full">
                        
                        <p><strong>Serena Waldorf</strong></p>
                    </div>

                    <p class="text-gray-600">18 minutes ago</p>
                </div>

                <p>Status Update: Struggling with an assignement, send coffee and food please!</p>
